...
<html>
<head>
  <title>Madurai City - An Overview</title>
  <style>
...
<body>
  <header>
    <h1>Madurai City - An Overview</h1>
  </header>

  <article>
    <img class="article-img" src="madurai.webp" alt="Madurai City">
    <p>
    ...
    <img class="article-img" src="thirumalaimahal.jpg" alt="Thirumalai Nayakkar Mahal">
    <p>
    ...
    <img class="article-img" src="vaigairiver.jpg" alt="Vaigai River">
    <p>
    ...
    <img class="article-img" src="alagar.jpg" alt="Alagar Koyil">
    <p>
    ...
    <div class="accommodation">
      ...
      <img class="accommodation-img" src="hoteltamilnadumdu1.jpg" alt="Hotel 1">
      <h3>Hotel Tamilnadu - 1</h3>
      <p>
    ...
    <div class="accommodation">
      <h2>Accommodation Facilities</h2>
      <img class="accommodation-img" src="hoteltamilnadumdu2.jpg" alt="Hotel 1">
      <h3>Hotel Tamilnadu - 2</h3>
      <p>
  ...
  <footer>
    <p>&copy; 2023 Madurai City Tourism. All rights reserved.</p>
  </footer>
</body>
</html>
