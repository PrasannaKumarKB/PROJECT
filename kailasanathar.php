...
<head>
    <title>Kailasanathar Temple, Thirumayam</title>
...
<body>
    <header>
        <h1>KAILASANATHAR TEMPLE,THIRUMAYAM</h1>
    </header>
    ...
    <div class="container">
        <div class="details-container">
            <h3>HISTORY</h3>
            <p>Kailasanathar Temple, also known as Thirumayam Temple, is a historic Hindu temple located in Thirumayam,
                Trichy. It is dedicated to Lord Shiva and is renowned for its architectural beauty and intricate
                carvings. The temple holds great religious significance and attracts devotees from far and wide. With a
                rich history that dates back several centuries, the Kailasanathar Temple stands as a testament to
                Dravidian architecture and showcases the craftsmanship of the artisans of that era.</p>
        </div>
    </div>
    <div class="container">
        <div class="details-container">
    ...
    <div class="container">
        <div class="details-container">
            <h4>LOCATION</h4>
            <p>Kailasanathar Temple, Thirumayam, Trichy, Tamil Nadu 622507</p>
        </div>
    </div>
    <div class="container">
        <div class="details-container">
