...
<html>
<head>
  <title>Chennai City - An Overview</title>
  <style>
...
<body>
  ...
  <a class="back-button" href="chennai.php" style="position: absolute; top: 20px; left: 20px; font-size: 48px; color:white;text-decoration: none;">&larr;</a>
    <h1>Chennai City - An Overview</h1>
  </header>

  <article>
    <img class="article-img" src="chennai.jpg" alt="Chennai City">
    <p>
    ...
    <img class="article-img" src="kapaleeshwarartemple.jpg" alt="Kapaleeshwarar Temple">
    <p>
    ...
    <img class="article-img" src="marinabeach.avif" alt="Marina Beach">
    <p>
    ...
    <img class="article-img" src="southindianfoods.jpg" alt="South Indian Food">
    <p>
    ...
    <div class="accommodation">
        ...
        <img class="accommodation-img" src="hoteltamilnadu.jpg" alt="Hotel 1">
  ...
  <footer>
    <p>&copy; 2023 Chennai City Tourism. All rights reserved.</p>
  </footer>
</body>
</html>
