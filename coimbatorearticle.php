...
<html>
<head>
  <title>Coimbatore City - An Overview</title>
  <style>
...
<body>
  <header>
    <h1>Coimbatore City - An Overview</h1>
  </header>

  <article>
    <img class="article-img" src="coimbatore.jpg" alt="Coimbatore City">
    <p>
    ...
    <img class="article-img" src="marudhamalai1.jpg" alt="Marudamalai Temple">
    <p>
    ...
    <img class="article-img" src="velliangiri1.jpg" alt="Eachanari Vinayagar Temple">
    <p>
    ...
    <img class="article-img" src="blackthunder.webp" alt="Black Thunder Theme Park">
    <p>
    ...
    <img class="article-img" src="southindianfoods.jpg" alt="Coimbatore Food">
    <p>
    ...
    <div class="accommodation">
      ...
      <img class="accommodation-img" src="tamilnaduhotelcbe.jpg" alt="Hotel Grand Regent">
  ...
  <footer>
    <p>&copy; 2023 Coimbatore City Tourism. All rights reserved.</p>
  </footer>
</body>
</html>
