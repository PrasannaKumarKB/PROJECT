...
<html>
<head>
  <title>Kapaleeshwarar Temple - Contact</title>
  <style>
...
<body>
  <h1>Kapaleeshwarar Temple - Contact</h1>
  ...
  <div class="contact-container">
    ...
    <div class="contact-info">
      ...
      <ul>
        <li>Phone: +91 44 2464 1670</li>
        <li>Email: info@kapaleeshwarartemple.com</li>
        <li>Address: 234, Ramakrishna Mutt Rd, Vinayaka Nagar Colony, Mylapore, Chennai, Tamil Nadu 600004</li>
      </ul>
    </div>
  </div>

  <footer class="footer">
    <p>&copy; 2023 Kapaleeshwarar Temple. All rights reserved.</p>
  </footer>
</body>
</html>
